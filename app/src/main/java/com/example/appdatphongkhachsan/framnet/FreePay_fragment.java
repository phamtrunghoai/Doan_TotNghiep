...
public class FreePay_fragment extends Fragment {
    DatPhongAdapter datPhongAdapter;
    ArrayList<khachsan> arrayKhachSan;
    ListView listViewKhachSanFreepay;
    public FreePay_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup t = (ViewGroup) inflater.inflate(R.layout.fragment_free_pay_fragment, container, false);
        listViewKhachSanFreepay = t.findViewById(R.id.listViewDatPhongfreepay);
        arrayKhachSan = new ArrayList<>();
        datPhongAdapter = new DatPhongAdapter(getContext(), arrayKhachSan);
        listViewKhachSanFreepay.setAdapter(datPhongAdapter);
