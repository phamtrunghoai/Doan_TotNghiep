...
public class Giamgia_fragment extends Fragment {

    DatPhongAdapter datPhongAdapter;
    ArrayList<khachsan> arrayKhachSan;
    ListView listViewKhachSanGiamgia;

    public Giamgia_fragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup t = (ViewGroup) inflater.inflate(R.layout.fragment_giamgia_fragment, container, false);
        listViewKhachSanGiamgia = t.findViewById(R.id.listViewDatPhonggiamgia);
        arrayKhachSan = new ArrayList<>();
        datPhongAdapter = new DatPhongAdapter(getContext(), arrayKhachSan);
        listViewKhachSanGiamgia.setAdapter(datPhongAdapter);
